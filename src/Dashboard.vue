					...
					<div class="widget-header ph-20 pt-20">
						<div class="flex justify-center align-center">
							...
							<div class="widget-info box grow text-truncate animated fadeInLeft">
								<div class="o-050 widget-title text-truncate pt-5 pb-10">Usuarios</div>
				...
				<div class="card-base card-shadow--medium mb-30 widget small-widget" v-loading="!asyncComponent">
					...
					<div class="widget-header ph-20 pt-20">
						<div class="flex justify-center align-center">
							...
							<div class="widget-info box grow text-truncate animated fadeInLeft">
								<div class="o-050 widget-title text-truncate pt-5 pb-10">Vistas</div>
				...
				<div class="card-base card-shadow--medium mb-30 widget small-widget" v-loading="!asyncComponent">
					...
					<div class="widget-header ph-20 pt-20">
						<div class="flex justify-center align-center">
							...
							<div class="widget-info box grow text-truncate animated fadeInLeft">
								<div class="o-050 widget-title text-truncate pt-5 pb-10">xdxdxdx</div>
				...
				<div class="card-base card-shadow--medium mb-30 widget small-widget" v-loading="!asyncComponent">
					...
					<div class="widget-header ph-20 pt-20">
						<div class="flex justify-center align-center">
							...
							<div class="widget-info box grow text-truncate animated fadeInLeft">
								<div class="o-050 widget-title text-truncate pt-5 pb-10">Ingresos</div>
				...
				<div class="card-base card-shadow--medium mb-30 widget small-widget" v-loading="!asyncComponent">
					...
					<div class="widget-header ph-20 pt-20">
						<div class="flex justify-center align-center">
							...
							<div class="widget-info box grow text-truncate animated fadeInLeft">
								<div class="o-050 widget-title text-truncate pt-5 pb-10">Mensajes</div>
				...
				<div class="card-base card-shadow--medium mb-30 widget small-widget" v-loading="!asyncComponent">
					...
					<div class="widget-header ph-20 pt-20">
						<div class="flex justify-center align-center">
							...
							<div class="widget-info box grow text-truncate animated fadeInLeft">
								<div class="o-050 widget-title text-truncate pt-5 pb-10">Compras</div>
		...
		<el-row class="mt-0" :gutter="30">
			<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
				<div class="card-base card-shadow--medium bg-accent p-20" style="height:400px" v-loading="!asyncChart1">
					<h1 class="white-text mv-0 animated fadeInDown">Estadísticas</h1>
					<h3 class="mt-0 mb-40 white-text o-050 animated slideInUp">Ingresos</h3>
				...
				<vue-scroll class="card-base card-shadow--medium mb-30" style="height:410px">
					...
					<table class="styled striped">
						<thead>
							<tr>
								<th></th>
								<th style="min-width:85px;">Nombre</th>
								<th style="min-width:80px;">Apellido</th>
								<th style="min-width:130px;">Actividad</th>
								<th style="min-width:195px;">Progresos</th>
							</tr>
						</thead>
						<tbody>
		...
		<el-row class="mt-0" :gutter="30">
			<el-col :xs="24" :sm="12" :md="10" :lg="8" :xl="6">
				<vue-scroll class="card-base card-shadow--medium p-20 mb-30" style="height:660px">
					<h2 class="mv-0 animated fadeInDown">Actividades</h2>
					<h4 class="mt-5 mb-40 animated slideInUp"><span class="o-050">Ultima actividad:</span><strong class="ml-10 o-070">2 days ago</strong></h4>

					<timeline timeline-theme="lightblue">
						<timeline-title>Hace dos dias</timeline-title>
						<timeline-item :hollow="true">
							Eres perfecta para miiiiiiiiiiii!.
						</timeline-item>
						<timeline-item :hollow="true">
							Just keep going on!.
						</timeline-item>
						<timeline-title>Hace 3 dias</timeline-title>
						<timeline-item :hollow="true">
							Don't stop the music!
						</timeline-item>
						<timeline-title>Hace 4 dias</timeline-title>
						<timeline-item :hollow="true">
							Born to Die!
						</timeline-item>
					</timeline>
			...
			<el-col :xs="24" :sm="12" :md="14" :lg="16" :xl="18">
				<div class="card-base card-shadow--medium p-20 mb-30" style="height:295px">
					<div class="flex justify-space-between">
						<div>
							<h2 class="mv-0 animated fadeInDown">Reportes</h2>
							<h4 class="mt-5 mb-40 o-050 animated slideInUp">Esta semana</h4>
						</div>
						<div class="radio-switcher">
							<el-radio-group v-model="radio2">
								<el-radio-button label="Dia"></el-radio-button>
								<el-radio-button label="Semana"></el-radio-button>
								<el-radio-button label="Mes"></el-radio-button>
							</el-radio-group>
						</div>
					...
					<h4 class="mb-0 mt-0">Usuarios nuevos</h4>
					<el-progress :percentage="100" status="success"></el-progress>
					<h4 class="mb-0">Visitas</h4>
					<el-progress :percentage="70"></el-progress>
					<h4 class="mb-0">xxxdxxdxx</h4>
				...
				<div class="card-base card-shadow--medium flex column mb-30 pv-20 bg-primary" style="height:295px;">
					<div class="ph-20">
						<h2 class="white-text mv-0 animated fadeInDown">Visitantes</h2>
						<h4 class="white-text mt-5 mb-0 o-050 animated slideInUp">Enero - Jul</h4>
					</div>
