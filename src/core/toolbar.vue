		...
		<div class="box-right flex align-center pl-10">
			<el-dropdown trigger="click" @command="onCommandLang">
				...
				<el-dropdown-menu slot="dropdown">
					...
					<el-dropdown-item command="it"><i class="flag-icon flag-icon-it mr-15"></i>ItalianO</el-dropdown-item>
					<el-dropdown-item command="fr"><i class="flag-icon flag-icon-fr mr-15"></i>Frances</el-dropdown-item>
					<el-dropdown-item command="de"><i class="flag-icon flag-icon-de mr-15"></i>Aleman</el-dropdown-item>
					<el-dropdown-item command="es"><i class="flag-icon flag-icon-es mr-15"></i>Español</el-dropdown-item>
					<el-dropdown-item command="cn"><i class="flag-icon flag-icon-cn mr-15"></i>Chino</el-dropdown-item>
					<el-dropdown-item command="jp"><i class="flag-icon flag-icon-jp mr-15"></i>Japones</el-dropdown-item>
					<el-dropdown-item command="/multi-language"><i class="mdi mdi-translate mr-15"></i>Leer Documentación</el-dropdown-item>
				</el-dropdown-menu>
			</el-dropdown>
			...
			<el-dropdown trigger="click" @command="onCommand">
				...
				<el-dropdown-menu slot="dropdown">
					...
					<el-dropdown-item command="/calendar"><i class="mdi mdi-calendar mr-10"></i> Calendario</el-dropdown-item>
					<el-dropdown-item command="/contacts"><i class="mdi mdi-account-multiple mr-10"></i> Contactos</el-dropdown-item>
